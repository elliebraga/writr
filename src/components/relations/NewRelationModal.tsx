          ...
          <div>
            ...
            {label === "Outro" && (
              <input
                ...
                className="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:border-slate-900 text-slate-900 placeholder:text-slate-600 bg-white mb-2"
              />
            )}
          </div>
