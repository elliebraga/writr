    ...
    <div className="flex-1 bg-white min-h-screen flex flex-col font-sans select-none overflow-hidden">
      ...
      {isLoading ? (
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          <div className="px-3.5 py-2.5 sm:px-6 sm:py-3.5 border-b border-slate-200 bg-white flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 shrink-0 z-30">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-xl font-bold font-funnel text-slate-900 tracking-tight">
                  Árvore & Relações de Personagens
                </h2>
                <span className="text-[10px] sm:text-xs px-2 sm:px-2.5 py-0.5 rounded-full font-bold bg-slate-100 text-slate-700 border border-slate-200">
                  {relationsData.links.length} {relationsData.links.length === 1 ? "conexão" : "conexões"}
                </span>
              </div>
              <p className="hidden sm:block text-xs text-slate-600 font-sans mt-0.5">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
              ...
              {relationsData.links.length > 0 && (
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2.5 sm:px-3.5 py-1.5 rounded-full text-xs font-semibold text-red-600 hover:bg-red-50 border border-red-200/80 transition-colors cursor-pointer"
                >
