      ...
      <aside className="fixed inset-0 md:inset-y-0 md:right-0 md:left-auto max-w-full flex md:pl-10 z-50">
        <div className="w-full md:w-[40vw] max-w-full md:max-w-none md:min-w-[420px] bg-white md:border-l border-slate-200 shadow-2xl flex flex-col h-full h-[100dvh] animate-in slide-in-from-bottom md:slide-in-from-right duration-300 ease-out">
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto overscroll-contain p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            {/* Ação de Linha do Tempo dentro do Formulário */}
            {characterToEdit && onNavigateToTimeline && (
              <div className="flex items-center justify-between p-3.5 bg-indigo-50/70 border border-indigo-100 rounded-xl">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-bold font-funnel text-indigo-950 truncate">Linha do Tempo</p>
                    <p className="text-[11px] text-indigo-700 font-sans truncate">Eventos e cronologia deste personagem</p>
                  </div>
                </div>
                <button
                  type="button"
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-indigo-700 bg-white border border-indigo-200 hover:bg-indigo-50 rounded-lg transition-colors cursor-pointer shadow-xs shrink-0"
                >
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  {imageUrl ? (
                    ...
                    <User className="w-7 h-7 text-slate-600 group-hover:text-slate-600 transition-colors" />
                  )}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5">
                ...
                {referenceImages.length < 8 && (
                  <button
                    type="button"
                    onClick={() => refFileInputRef.current?.click()}
                    className="aspect-square rounded-xl border-2 border-dashed border-slate-200 hover:border-slate-400 bg-slate-50/50 hover:bg-slate-100 flex flex-col items-center justify-center text-slate-600 hover:text-slate-700 transition-all cursor-pointer"
                  >
          ...
          {/* Footer Fixo */}
          <div className="p-4 sm:px-6 pb-[max(1rem,env(safe-area-inset-bottom))] border-t border-slate-200 bg-white flex items-center justify-between gap-3 shrink-0">
